...
## Burden
[TODO: define — perhaps none; Buddy might be the rare character who's genuinely happy with what he has]
...
## Voice
- [TODO: define speech patterns — likely upbeat, easygoing, the kind of guy who's just happy to be here]

## Secrets
- [TODO: add hidden lore]

## Arc
- [TODO: define character arc — does Buddy ever get competitive, or is he the heart of the community?]

## State Defaults
- **Default Mood**: `<|mood: playful|>` (happy-go-lucky)
- **Fortune**: [TODO]
